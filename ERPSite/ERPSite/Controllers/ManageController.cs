...
namespace ERPSite.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(HttpPostedFileBase postedFile)
        {
            ...
            if (bytes != null)
            {
                var userIdLocal = User.Identity.GetUserId();
                var userLocal = await UserManager.FindByIdAsync(userIdLocal);
                userLocal.Image = bytes;
                await UserManager.UpdateAsync(userLocal);
            }
